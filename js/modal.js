function modal(){
    ...
    var capaModal = document.getElemtsByClassName("modal-reposo");
    ...
    for(i = 0; i < capaModal.length; i++){
        ...
        function ventModal(i){
            ...
            capaModal[i].addEventListener("click",function(){
                var infoModal = this.getElemtsByClassName("info-modal-reposo")[0];
                var altoVent = html.offsetHeight;
                var body = document.getElementsByTagName("body")[0];
                var cerrar = this.getElemtsByClassName("alin-dcha")[0];
